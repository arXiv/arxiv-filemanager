...
class TestAPIWithQuarantineStorage(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.base_workdir = tempfile.mkdtemp()
        ...
        self.app.config['STORAGE_BASE_PATH'] = self.base_workdir
    ...
    def test_upload_overwrite(self):
        ...
        payload = io.BytesIO(b'The first version')
        ...
        payload = io.BytesIO(b'The second version')
        response = self.client.post(f'/filemanager/api/{upload_id}',
                                    data={'file': (payload, 'payload.txt')},
                                    headers={'Authorization': self.token},
                                    content_type='multipart/form-data')
        ...
        response = self.client.get(
            f'/filemanager/api/{upload_id}/payload.txt/content',
            headers={'Authorization': self.token}
        )
